...
function viewCourseGrades(courseNumber) {
  ...
  if (courseListRow.style.display !== "none") {
    ReactDOM.render(
      <ViewGradesTable usn={getCookie("username")} location="view-grades" />,
      courseGrades
    );
  }
        ...
        <Col xs={12} sm={6} xl={2} className="mb-4">
          <div className="shadow-soft rounded border-light p-2 w-75 fmxw-500">
            <Button
              ...
              className="text-dark"
              style={{ color: "white" }}
              onClick={viewCourseGrades.bind(this, courseList[course])}
            >
              <h5>Course #{courseList[course]}</h5>
            </Button>
          </div>
        </Col>
      </>
      ...
      <>
        ...
        >
          <Button
            ...
            className="text-dark"
            style={{ color: "white" }}
            onClick={viewCourseGrades.bind(this)}
          >
        ...
        <div id="courseGrades" style={{ display: "none" }}></div>
      </>
    );
  } else {
